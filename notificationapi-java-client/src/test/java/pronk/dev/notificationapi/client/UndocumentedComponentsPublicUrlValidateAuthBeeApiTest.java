...
/**
 * API tests for UndocumentedComponentsPublicUrlValidateAuthBeeApi
 */
class UndocumentedComponentsPublicUrlValidateAuthBeeApiTest {

    private final UndocumentedComponentsPublicUrlValidateAuthBeeApi api = new UndocumentedComponentsPublicUrlValidateAuthBeeApi();
     ...
     */
    @Test
    void envIdComponentsPublicUrlValidateAuthBeeGetTest() throws ApiException {
        //
        //String envId = null;
        //
        //String response = api.envIdComponentsPublicUrlValidateAuthBeeGet(envId);
     ...
     */
    @Test
    void envIdComponentsPublicUrlValidateAuthBeeOptionsTest() throws ApiException {
        //
        //String envId = null;
        //
        //String response = api.envIdComponentsPublicUrlValidateAuthBeeOptions(envId);
