...
public class UndocumentedApi {
  ...
  public UndocumentedApi() {
    this(Configuration.getDefaultApiClient());
  }

  public UndocumentedApi(ApiClient apiClient) {
   ...
   */
  public Object envIdGet(String envId, String accept) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'envId' is set
    if (envId == null) {
      throw new ApiException(400, "Missing the required parameter 'envId' when calling envIdGet");
    }
    
    // create path and map variables
    String localVarPath = "/{envId}".replaceAll("\\{format\\}","json")
   ...
   * @throws ApiException if fails to make API call
   */
  public String envIdPatch(String envId, String contentType, Object body) throws ApiException {
    Object localVarPostBody = body;
    
    // verify the required parameter 'envId' is set
    if (envId == null) {
      throw new ApiException(400, "Missing the required parameter 'envId' when calling envIdPatch");
    }
